...
CREATE TABLE IF NOT EXISTS 'veterinaria'.'emp_empleados' (
  'emp_id' INT NOT NULL COMMENT AUTO_INCREMENT 'ID de empleado' ,
...
CREATE TABLE IF NOT EXISTS 'veterinaria'.'mun_municipio' (
  'mun_id' INT NOT NULL COMMENT AUTO_INCREMENT 'ID del municipio',
...
CREATE TABLE IF NOT EXISTS 'veterinaria'.'prop_propietarios' (
  'prop_id' INT NOT NULL COMMENT AUTO_INCREMENT 'ID del propietario',
...
CREATE TABLE IF NOT EXISTS 'veterinaria'.'usr_usuarios' (
  'usr_id' INT NOT NULL COMMENT AUTO_INCREMENT 'ID de usuario',
...
CREATE TABLE IF NOT EXISTS 'veterinaria'.'doc_doctores' (
  'doc_id' INT NOT NULL COMMENT AUTO_INCREMENT 'ID del doctor',
...
CREATE TABLE IF NOT EXISTS 'veterinaria'.'mas_mascotas' (
  'mas_id' INT NOT NULL COMMENT AUTO_INCREMENT 'ID del tipo de mascotas',
...
CREATE TABLE IF NOT EXISTS 'veterinaria'.'infm_informacion_mascotas' (
  'infm_id' INT NOT NULL COMMENT 'ID de la mascota',
